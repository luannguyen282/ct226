...
<body>
	...
	<div id="header">
		...
		<div id="header-button-box" >
			<a href="">
				...
				<span class="button-title" >Giỏ hàng</span>
			</div>
			</a>
			<a href="">
				<div class="button-container">
				...
				<span class="button-title">Đơn hàng</span>
			</div>
			</a>
			<a href="info.php">
				<div class="button-container">
				...
				<span class="button-title"><?php echo $_SESSION['username']; ?></span>
			</div>
			</a>
			<a href="">
				<div class="button-container">
	...
	<div id="main">
				...
				<div id="seller">
					...
					<p><span>Khoa: </span><select name="khoa">
						<?php 
						 ...
						 ?>
						 <option <?php if($dskhoa['makhoa']==$nguoidung['makhoa']) echo "selected";?> value="<?php echo $nguoidung['makhoa']; ?>"><?php echo $dskhoa['tenkhoa']; ?></option>
						<?php } ?>
						</select>
					</p>
		...
		<div id="right">
			<ul id="tag">
				<li id="li1" onclick="sharing(); page('first');">Đang chia sẻ</li>
				<li id="li2" onclick="shared(); page('first');">Đã chia sẻ</li>
				<li id="li3" onclick="exchanging(); page('first');">Đang trao đổi</li>
				<li id="li4" onclick="lock(); page('first');">Tạm ẩn</li>
			</ul>
			<div id="seller-pro">
				<div id="sharing">
					
					<div class="product" id="add-new-1">
						<button id="but-add-new" onclick="addPro();">Thêm tài liệu</button>			
					</div>
					<form method="POST" action="../Form/new-product.php" enctype="multipart/form-data">
						<div class="product" id="add-new-2">
							...
							<div class="pro-name" id="new-pro-price"><p>Giá:</p><input type="number" name="g" min="1000" max="999999"> vnđ</div>
				...
				<div id="exchanging" style="display: none;">
					<?php 
						...
						?>	
							<a href="../Public/product.php?matailieu=<?php echo $matailieu; ?>&submit=test" >
				...
				<div id="lock" style="display: none;">
					<?php 
						...
						?>	
							...
							<form method="POST" action="../Form/edit-product.php">
								<div class="product" id="<?php echo "lock".$dstl['matailieu']; ?>">
									<div class="photo-container">
									...
									<div class="pro-info">
										...
										<div class="pro-button">
											...
											<input type="button" class="button-2" value="Sửa" onclick="editPro(<?php echo $dstl['matailieu']; ?>);">
							...
							<form method="POST" action="../Form/edit-product.php" enctype="multipart/form-data">
								<div class="product" id="<?php echo "lockE".$dstl['matailieu']; ?>" style="display: none;">
									<div class="new-pro-photo-container">
									...
									<div class="pro-name" id="edit-pro-price"><p>Giá:</p><input type="number" name="g" min="1000" max="999999" value="<?php echo $dstl['gia']; ?>"> vnđ</div>
									<div class="pro-button" style="margin-top: 20px;">
										<input type="button" class="button-2" value="Huỷ bỏ" onclick="editProC(<?php echo $dstl['matailieu']; ?>);">
										<input type="submit" class="button-1" name="edit" value="Lưu thay đổi">
									</div>	
									</div>
								</div>			
							</form>
