...
<body>
	...
	<div id="main">
		...
		<div id="filter">
			<form >
				...
				<select id="khoa" name="Khoa">
					<option class="option">Tất cả</option>
					<?php 
						$sql = "SELECT * FROM `khoa`;";
						$khoa = mysqli_query($con, $sql);
						while($dskhoa = mysqli_fetch_array($khoa)){
						echo "<option class=\"option\">".$dskhoa['tenkhoa']."</option>";
						}
					 ?>
				...
				<select id="loai" name="loai">
					...
					<?php 
						...
						echo "<option class=\"option\">".$dsltl['tenloai']."</option>";
						}
					 ?>
				</select>
				...
				<select id="domoi" name="domoi">
					<option class="option">Tất cả</option>
					<option class="option">100% - Chưa sử dụng</option>
					<option class="option">Từ 80% - Rất tốt</option>
					<option class="option">Từ 65% - Khá tốt</option>
					<option class="option">Từ 50% - Tương đối</option>
					<option class="option">Dưới 50% - Kém</option>
				</select>
		...
		<div id="product-container">
			...
			<?php 
				$ps=($page-1)*8;
				$sql = "SELECT * FROM `tailieu` WHERE `matrangthai` LIKE 'sharing' AND `tentailieu` LIKE '%$keyword%' LIMIT $ps,8;";
							...
							<div class="product">
								...
								<div class="pro-info">
									...
									<div class="pro-button">
										<input type="submit" class="button-1" name="submit" value="Đánh dấu">
										<input type="submit" class="button-2" id="b2" name="submit" value="Trao đổi ngay">
									</div>	
								</div>
				...
				$numrows=mysqli_query($con, "SELECT COUNT(*) as `num` FROM `tailieu` WHERE `matrangthai` LIKE 'sharing' AND `tentailieu` LIKE '%$keyword%';");
